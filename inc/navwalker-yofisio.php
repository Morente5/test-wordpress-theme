...
class WP_Bootstrap_Navwalker_YoFisio extends Walker_Nav_Menu {
	/**
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			*/
			...
			$item_output .= ( $args->has_children && 0 === $depth ) ? ' </a><a class="dropdown-toggle nav-link" data-toggle="dropdown"></a>' : '</a>';
